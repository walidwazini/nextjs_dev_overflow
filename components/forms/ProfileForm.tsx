...
const ProfileForm = ({ clerkId, user }: ProfileFormProps) => {
  ...
  const form = useForm<z.infer<typeof ProfileSchema>>({
    ...
    defaultValues: {
      name: parsedUser ? parsedUser.name : '',
      username: parsedUser ? parsedUser.username : "",
      portfolioWebsite: parsedUser ? parsedUser.portfolioWebsite : '',
      location: parsedUser ? parsedUser.location : '',
      bio: parsedUser ? parsedUser.bio : ''
    },
  })
